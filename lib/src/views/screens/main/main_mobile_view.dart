...
import 'package:challenge/src/core/util/validators.dart';
...
class MainMobileView extends StatelessWidget {
  MainMobileView({Key? key}) : super(key: key);
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  _selectImagesFromGallery(mainBloc),
                ],
              ),
            ],
          ),
  ...
  Widget _selectImagesFromGallery(MainBloc mainBloc) {
    return Expanded(
      flex: 1,
...
class _UploadDataButtonWidget extends StatelessWidget {
  ...
  _UploadDataButtonWidget({Key? key,
    required this.emailController,
    required this.pointUrlController,required this.formKey})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<MainBloc, MainState>(
      buildWhen: (previous, current) {
        if (current.isSendingData || !current.isSendingData) {
          return true;
        } else {
          return false;
        }
